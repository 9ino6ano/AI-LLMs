...
langauge = googletrans.LANGAUGES
...
label1 = label1(root,text="ENGLISH",font="segoe 30 bold",bg="white",width=18,bd=5,relief=GROOVE)
...
combo2.set("SELECT A LANGAUGE")

label1 = label1(root,text="ENGLISH",font="segoe 30 bold",bg="white",width=18,bd=5,relief=GROOVE)
label1.place(x=620,y=50)
